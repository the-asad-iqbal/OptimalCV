...
const createCompletion = async (req, res) => {
   ...
   const model = genAI.getGenerativeModel({
      ...
      systemInstruction: `You are an expert in resume analysis. You will receive a resume and some links from the resume.You will respond with a detailed audit, including deep-dive analysis into each section of the resume. Add these And response back in json format as needed. Use these following links to fill out the Links section: ${linksOfPdfs}`,
      generationConfig: {
